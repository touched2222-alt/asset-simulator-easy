    ...
    try:
        ...
        for key, value in data.items():
            if key in st.session_state:
                # ユーザーが操作した直後に読み込むとエラーになるため、key指定で直接上書き
                st.session_state[key] = value
        st.sidebar.success("✅ 設定ファイルを読み込みました！アプリが更新されます。")
...
def main():
    # アプリ起動時にデフォルト設定値をst.session_stateにロード（初期化処理）
    ...
    with tab5:
        ...
        inc1_age = st.number_input("収入① 年齢", 0, 100, value=st.session_state.inc1_a, key="inc1_a")
        ...
        inc2_age = st.number_input("収入② 年齢", 0, 100, value=st.session_state.inc2_a, key="inc2_a")
        ...
        inc3_age = st.number_input("収入③ 年齢", 0, 100, value=st.session_state.inc3_a, key="inc3_a")
        ...
        dec1_age = st.number_input("支出① 年齢", 0, 100, value=st.session_state.dec1_a, key="dec1_a")
        ...
        dec2_age = st.number_input("支出② 年齢", 0, 100, value=st.session_state.dec2_a, key="dec2_a")
